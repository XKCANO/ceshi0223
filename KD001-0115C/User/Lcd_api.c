...
void LCDDisplay(void)
{
		switch(Display.Step)
		{
			case 0:
				...
				break;
			case 1:
				Display.Ppm = Display.Ppm > 999 ?  999:Display.Ppm;
				Display.Current = (uint16_t)Display.Ppm / 100;	
				//百位
				...
				//十位
				Display.Current =(uint16_t)(Display.Ppm / 10) % 10;
			...
			case 2:
				//个位
				Display.Current = (uint16_t)Display.Ppm % 10;
