...
#define         IS_FL_GPIO_DRIVESTRENGTH(__VALUE__)         (((__VALUE__) == FL_GPIO_DRIVESTRENGTH_X1)||\
...
#define         IS_FL_GPIO_WKUP_ENTRY(__VALUE__)            (((__VALUE__) == FL_GPIO_WAKEUP_INT_ENTRY_NMI)||\
                                                             ((__VALUE__) == FL_GPIO_WAKEUP_INT_ENTRY_39))
...
void FL_GPIO_StructInit(FL_GPIO_InitTypeDef *initStruct)
{
	...
	initStruct->driveStrength  = FL_GPIO_DRIVESTRENGTH_X4;
}
