...
#define IS_FL_GPTIM_SLAVE_MODE(__VALUE__)           (((__VALUE__) == FL_GPTIM_SLAVE_MODE_PROHIBITED)\
                                                    || ((__VALUE__) == FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI1)\
                                                    ...
                                                    || ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_CLK)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_RISE_RST_RUN)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_HIGH_RISE_RUN)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLK_DIR_X2)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLK_DIR_X1)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLKWithDIR_X2)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLKWithDIR_X1)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI1)\
																										|| ((__VALUE__) == FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI2))
																										


#define IS_FL_GPTIM_TRIGGER_SRC(__VALUE__)          (((__VALUE__) ==FL_GPTIM_TRGI_ITR0 )\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_ITR1 )\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_ITR2)\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_ITR3)\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_TI1F_ED)\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_TI1FP1)\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_TI2FP2)\
                                                        ||((__VALUE__) ==FL_GPTIM_TRGI_ETRF)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR4)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR5)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR6)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR7)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR8)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR9)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR10)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR11)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR12)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR13)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR14)\
																												||((__VALUE__) ==FL_GPTIM_TRGI_ITR15))
...
#define IS_FL_GPTIM_OC_MODE(__VALUE__)               (((__VALUE__) ==   FL_GPTIM_OC_MODE_FROZEN) \
                                                      ...
                                                      || ((__VALUE__) == FL_GPTIM_OC_MODE_PWM2)\
																											|| ((__VALUE__) == FL_GPTIM_OC_MODE_RETRIG_OPM1)\
																											|| ((__VALUE__) == FL_GPTIM_OC_MODE_RETRIG_OPM2)\
																											|| ((__VALUE__) == FL_GPTIM_OC_MODE_COMBINED_PWM1)\
																											|| ((__VALUE__) == FL_GPTIM_OC_MODE_COMBINED_PWM2)\
																											|| ((__VALUE__) == FL_GPTIM_OC_MODE_ASSYMETRIC_PWM1)\
																											|| ((__VALUE__) == FL_GPTIM_OC_MODE_ASSYMETRIC_PWM2))
...
void FL_GPTIM_SlaveMode_StructInit(FL_GPTIM_SlaveInitTypeDef *slave_init)
{
    ...
    slave_init->triggerSrc      = FL_GPTIM_TRGI_TI1FP1;
