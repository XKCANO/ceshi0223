...
FL_ErrorStatus FL_BSTIM16_DeInit(BSTIM16_Type *BSTIM16x)
{
    ...
    FL_CMU_DisableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_BSTIM16);
    /* 锁定外设复位 */
...
FL_ErrorStatus FL_BSTIM16_Init(BSTIM16_Type *BSTIM16x, FL_BSTIM16_InitTypeDef *init)
{
    ...
    if(init != NULL)
    {
        ...
        FL_CMU_EnableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_BSTIM16);
        /* 分频系数 */
