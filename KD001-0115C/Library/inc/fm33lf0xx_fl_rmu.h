...
#ifndef __FM33LF0XX_FL_RMU_H
#define __FM33LF0XX_FL_RMU_H
...
#define    RMU_RSTFR_CLM_FLAG_Pos                                 (7U)
#define    RMU_RSTFR_CLM_FLAG_Msk                                 (0x1U << RMU_RSTFR_CLM_FLAG_Pos)
#define    RMU_RSTFR_CLM_FLAG                                     RMU_RSTFR_CLM_FLAG_Msk
...
#define    RMU_RSTFR_SVDN_FLAG_Pos                                (3U)
...
#define    FL_RMU_RSTAPB_LED                                      (0x3fU << 0U)
#define    FL_RMU_RSTAPB_LCD                                      (0x3eU << 0U)
#define    FL_RMU_RSTAPB_CLM1                                     (0x3dU << 0U)
#define    FL_RMU_RSTAPB_CLM0                                     (0x3cU << 0U)
#define    FL_RMU_RSTAPB_TAU                                      (0x3bU << 0U)
#define    FL_RMU_RSTAPB_OPACR                                    (0x3aU << 0U)
#define    FL_RMU_RSTAPB_DACCR                                    (0x39U << 0U)
#define    FL_RMU_RSTAPB_ADCCR                                    (0x38U << 0U)
#define    FL_RMU_RSTAPB_ADC                                      (0x37U << 0U)
#define    FL_RMU_RSTAPB_DIVAS                                    (0x33U << 0U)
...
/**
  * @brief    Get CLM1 Timeout Reset Flag
  * @rmtoll   RSTFR    CLM1_TOUT_FLAG    FL_RMU_IsActiveFlag_CLM1TOUT
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLM1TOUT(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_CLM1_TOUT_FLAG_Msk) == (RMU_RSTFR_CLM1_TOUT_FLAG_Msk));
}

/**
  * @brief    Clear CLM1 Timeout Reset Flag
  * @rmtoll   RSTFR    CLM1_TOUT_FLAG    FL_RMU_ClearFlag_CLM1TOUT
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLM1TOUT(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_CLM1_TOUT_FLAG_Msk);
}

/**
  * @brief    Get CLM1 Update Reset Flag
  * @rmtoll   RSTFR    CLM1_UDF_FLAG    FL_RMU_IsActiveFlag_CLM1UDF
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLM1UDF(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_CLM1_UDF_FLAG_Msk) == (RMU_RSTFR_CLM1_UDF_FLAG_Msk));
}

/**
  * @brief    Clear CLM1 Update Reset Flag
  * @rmtoll   RSTFR    CLM1_UDF_FLAG    FL_RMU_ClearFlag_CLM1UDF
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLM1UDF(RMU_Type* RMUx)
{
...
/**
  ...
  * @rmtoll   RSTFR    CLM1_OVF_FLAG    FL_RMU_IsActiveFlag_CLM1OVF
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLM1OVF(RMU_Type* RMUx)
{
...
/**
  ...
  * @rmtoll   RSTFR    CLM1_OVF_FLAG    FL_RMU_ClearFlag_CLM1OVF
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLM1OVF(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_CLM1_OVF_FLAG_Msk);
}

/**
  * @brief    Get CLM0 Timeout Reset Flag
  * @rmtoll   RSTFR    CLM0_TOUT_FLAG    FL_RMU_IsActiveFlag_CLM0TOUT
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLM0TOUT(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_CLM0_TOUT_FLAG_Msk) == (RMU_RSTFR_CLM0_TOUT_FLAG_Msk));
}

/**
  * @brief    Clear CLM0 Timeout Reset Flag
  * @rmtoll   RSTFR    CLM0_TOUT_FLAG    FL_RMU_ClearFlag_CLM0TOUT
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLM0TOUT(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_CLM0_TOUT_FLAG_Msk);
}

/**
  * @brief    Get CLM0 Update Reset Flag
  * @rmtoll   RSTFR    CLM0_UDF_FLAG    FL_RMU_IsActiveFlag_CLM0UDF
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLM0UDF(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_CLM0_UDF_FLAG_Msk) == (RMU_RSTFR_CLM0_UDF_FLAG_Msk));
}

/**
  * @brief    Clear CLM0 Update Reset Flag
  * @rmtoll   RSTFR    CLM0_UDF_FLAG    FL_RMU_ClearFlag_CLM0UDF
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLM0UDF(RMU_Type* RMUx)
{
...
/**
  ...
  * @rmtoll   RSTFR    CLM0_OVF_FLAG    FL_RMU_IsActiveFlag_CLM0OVF
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLM0OVF(RMU_Type* RMUx)
{
...
/**
  ...
  * @rmtoll   RSTFR    CLM0_OVF_FLAG    FL_RMU_ClearFlag_CLM0OVF
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLM0OVF(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_CLM0_OVF_FLAG_Msk);
}

/**
  * @brief    Get RAM Parity Error Reset  Flag
  * @rmtoll   RSTFR    RAMP_FLAG    FL_RMU_IsActiveFlag_RAMP
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_RAMP(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_RAMP_FLAG_Msk) == (RMU_RSTFR_RAMP_FLAG_Msk));
}

/**
  * @brief    Clear RAM Parity Error Reset Flag
  * @rmtoll   RSTFR    RAMP_FLAG    FL_RMU_ClearFlag_RAMP
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_RAMP(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_RAMP_FLAG_Msk);
}

/**
  * @brief    Get MAP Error Reset Flag
...
/**
  * @brief    Clear MAP Error Reset Flag
...
/**
  * @brief    Get CLM Reset Flag
  * @rmtoll   RSTFR    CLM_FLAG    FL_RMU_IsActiveFlag_CLMN
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_CLMN(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_CLM_FLAG_Msk) == (RMU_RSTFR_CLM_FLAG_Msk));
}

/**
  * @brief    Clear CLM Reset Flag
  * @rmtoll   RSTFR    CLM_FLAG    FL_RMU_ClearFlag_CLMN
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_CLMN(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_CLM_FLAG_Msk);
}

/**
  * @brief    Get TEST Reset Flag
  * @rmtoll   RSTFR    TESTN_FLAG    FL_RMU_IsActiveFlag_TESTN
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_TESTN(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_TESTN_FLAG_Msk) == (RMU_RSTFR_TESTN_FLAG_Msk));
}

/**
  * @brief    Clear TEST Reset Flag
  * @rmtoll   RSTFR    TESTN_FLAG    FL_RMU_ClearFlag_TESTN
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_TESTN(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_TESTN_FLAG_Msk);
}
...
/**
  ...
  * @rmtoll   RSTFR    SVDN_FLAG    FL_RMU_IsActiveFlag_SVDN
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RMU_IsActiveFlag_SVDN(RMU_Type* RMUx)
{
    return (uint32_t)(READ_BIT(RMUx->RSTFR, RMU_RSTFR_SVDN_FLAG_Msk) == (RMU_RSTFR_SVDN_FLAG_Msk));
}

/**
  * @brief    Clear SVD Reset Flag
  * @rmtoll   RSTFR    SVDN_FLAG    FL_RMU_ClearFlag_SVDN
  * @param    RMUx RMU instance
  * @retval   None
  */
__STATIC_INLINE void FL_RMU_ClearFlag_SVDN(RMU_Type* RMUx)
{
    WRITE_REG(RMUx->RSTFR, RMU_RSTFR_SVDN_FLAG_Msk);
}
...
/**
  ...
  *           @arg @ref FL_RMU_RSTAPB_LED
  *           @arg @ref FL_RMU_RSTAPB_LCD
  *           @arg @ref FL_RMU_RSTAPB_CLM1
  *           @arg @ref FL_RMU_RSTAPB_CLM0
  *           @arg @ref FL_RMU_RSTAPB_TAU
  *           @arg @ref FL_RMU_RSTAPB_OPACR
  *           @arg @ref FL_RMU_RSTAPB_DACCR
