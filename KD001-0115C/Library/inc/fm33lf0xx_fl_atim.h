...
#ifndef __FM33LF0XX_FL_ATIM_H
#define __FM33LF0XX_FL_ATIM_H
...
#define    ATIM_CR2_MMS_Msk                                       (0xfU << ATIM_CR2_MMS_Pos)
...
#define    ATIM_SMCR_TS_Msk                                       (0x1fU << ATIM_SMCR_TS_Pos)
...
#define    ATIM_ISR_UIFCPY_Pos                                    (31U)
#define    ATIM_ISR_UIFCPY_Msk                                    (0x1U << ATIM_ISR_UIFCPY_Pos)
#define    ATIM_ISR_UIFCPY                                        ATIM_ISR_UIFCPY_Msk
...
#define    ATIM_AFR_BKSYS3E_Pos                                   (8U)
#define    ATIM_AFR_BKSYS3E_Msk                                   (0xfU << ATIM_AFR_BKSYS3E_Pos)
#define    ATIM_AFR_BKSYS3E                                       ATIM_AFR_BKSYS3E_Msk

#define    ATIM_AFR_BKIN1E_Pos                                    (0U)
#define    ATIM_AFR_BKIN1E_Msk                                    (0x3fU << ATIM_AFR_BKIN1E_Pos)
#define    ATIM_AFR_BKIN1E                                        ATIM_AFR_BKIN1E_Msk
...
#define    FL_ATIM_SLAVE_MODE_EXT_MODE1                           (0x7U << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_COMBINED_RESETTRIGGER               (0x8U << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_COMBINED_GATEDRESET                 (0x9U << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_CLOCKPLUSDIRECTION_X2               (0xaU << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_CLOCKPLUSDIRECTION_X1               (0xbU << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_DIRECTIONALCLOCK_X2                 (0xcU << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_DIRECTIONALCLOCK_X1                 (0xdU << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_X1_TI1                              (0xeU << ATIM_SMCR_SMS_Pos)
#define    FL_ATIM_SLAVE_MODE_X1_TI2                              (0xfU << ATIM_SMCR_SMS_Pos)
...
#define    FL_ATIM_BREAK_FILTER_DIV2_N6                           (0x4U << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV2_N8                           (0x5U << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV4_N6                           (0x6U << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV4_N8                           (0x7U << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV8_N6                           (0x8U << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV8_N8                           (0x9U << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV16_N5                          (0xaU << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV16_N6                          (0xbU << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV16_N8                          (0xcU << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV32_N5                          (0xdU << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV32_N6                          (0xeU << ATIM_BDTR_BKF_Pos)
#define    FL_ATIM_BREAK_FILTER_DIV32_N8                          (0xfU << ATIM_BDTR_BKF_Pos)
...
#define    FL_ATIM_ETRSOURCE_GPIO                                 (0x0U << ATIM_AFR_ETRSEL_Pos)
#define    FL_ATIM_ETRSOURCE_COMP1                                (0x1U << ATIM_AFR_ETRSEL_Pos)
#define    FL_ATIM_ETRSOURCE_COMP2                                (0x2U << ATIM_AFR_ETRSEL_Pos)
#define    FL_ATIM_ETRSOURCE_COMP3                                (0x3U << ATIM_AFR_ETRSEL_Pos)
...
#define    FL_ATIM_BKIN_SOURCE_GPIO1                              (0x1U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_GPIO2                              (0x2U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_COMP1                              (0x4U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_COMP2                              (0x8U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_COMP3                              (0x10U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_HFDET                              (0x100U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_SVD                                (0x200U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_LOCKUP                             (0x400U << ATIM_AFR_BKIN1E_Pos)
#define    FL_ATIM_BKIN_SOURCE_RAMPARITY                          (0x800U << ATIM_AFR_BKIN1E_Pos)
...
/**
  ...
  *           @arg @ref FL_ATIM_TRGO_OC5REF
  *           @arg @ref FL_ATIM_TRGO_OC6REF
  *           @arg @ref FL_ATIM_TRGO_OC4REF_RISINGFALLING
  *           @arg @ref FL_ATIM_TRGO_OC6REF_RISINGFALLING
  *           @arg @ref FL_ATIM_TRGO_OC4REF_RISING_OC6REF_RISING
  *           @arg @ref FL_ATIM_TRGO_OC4REF_RISING_OC6REF_FALLING
  *           @arg @ref FL_ATIM_TRGO_OC5REF_RISING_OC6REF_RISING
  *           @arg @ref FL_ATIM_TRGO_OC5REF_RISING_OC6REF_FALLING
  * @param    TIMx TIM instance
  * @param    triggerOutput This parameter can be one of the following values:
  *           @arg @ref FL_ATIM_TRGO_UG
  *           @arg @ref FL_ATIM_TRGO_ENABLE
...
__STATIC_INLINE uint32_t FL_ATIM_IsActiveFlag_CCOverflow(ATIM_Type* TIMx, uint32_t channel)
{
    if(channel>0x4U)
	{
	    return (uint32_t)(READ_BIT(TIMx->ISR, (ATIM_ISR_CCOF_Msk << channel<<2)) == (ATIM_ISR_CCOF_Msk << channel<<2));
	}
	else
	{
...
__STATIC_INLINE void FL_ATIM_ClearFlag_CCOverflow(ATIM_Type* TIMx, uint32_t channel)
{
    if(channel>0x4U)
	{
	       WRITE_REG(TIMx->ISR, (ATIM_ISR_CCOF_Msk << channel<<2));
	}
	else
	{
...
{
    return (uint32_t)(READ_BIT(TIMx->CNT, ATIM_ISR_UIFCPY_Msk) == (ATIM_ISR_UIFCPY_Msk));
}
...
/**
  ...
  *           @arg @ref FL_ATIM_ETRSOURCE_GPIO
  *           @arg @ref FL_ATIM_ETRSOURCE_COMP1
  *           @arg @ref FL_ATIM_ETRSOURCE_COMP2
  *           @arg @ref FL_ATIM_ETRSOURCE_COMP3
  * @retval   None
  */
...
{
    MODIFY_REG(TIMx->AFR, ATIM_AFR_BKIN1E_Msk, BRKsource);
}
...
{
   return (uint32_t)(READ_BIT(TIMx->AFR, ATIM_AFR_BKSYS3E_Msk));
}
