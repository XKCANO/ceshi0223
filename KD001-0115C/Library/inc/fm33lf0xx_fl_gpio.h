...
#ifndef __FM33LF0XX_FL_GPIO_H
#define __FM33LF0XX_FL_GPIO_H
...
#define    FL_GPIO_EXTI_LINE_15_PD13                              (0x1U << 30U)
#define    FL_GPIO_EXTI_LINE_15_PD14                              (0x2U << 30U)
#define    FL_GPIO_EXTI_LINE_15_PD15                              (0x3U << 30U)
...
#define    FL_GPIO_FOUT0_SELECT_ADC_SOC                           (0xaU << GPIO_FOUTSEL_FOUT0_Pos)
...
#define    FL_GPIO_FOUT1_SELECT_TSC_VCOMP                         (0xaU << GPIO_FOUTSEL_FOUT1_Pos)
...
#define    FL_GPIO_WAKEUP_INT_ENTRY_39                            (0x1U << GPIO_PINWKEN_WKISEL_Pos)
...
#define    FL_GPIO_DRIVESTRENGTH_X1                               (0x0U << GPIO_DSR_Pos)
#define    FL_GPIO_DRIVESTRENGTH_X2                               (0x1U << GPIO_DSR_Pos)
...
/**
  ...
  * @rmtoll   PUDEN    PUDEN    FL_GPIO_EnablePinPullup
  * @param    GPIOx GPIO Port
  * @param    pin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_PIN_0
  *           @arg @ref FL_GPIO_PIN_1
...
{
    SET_BIT(GPIOx->PUDEN, ((pin & 0xffff) << 0U));
}

/**
  * @brief    GPIOx Pull-Up disable
  * @rmtoll   PUDEN    PUDEN    FL_GPIO_DisablePinPullup
  * @param    GPIOx GPIO Port
  * @param    pin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_PIN_0
  *           @arg @ref FL_GPIO_PIN_1
...
{
    CLEAR_BIT(GPIOx->PUDEN, ((pin & 0xffff) << 0U));
}

/**
  * @brief    Get GPIOx Pull-Up enable status
  * @rmtoll   INEN        FL_GPIO_IsEnabledPinPullup
  * @param    GPIOx GPIO Port
  * @param    pin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_PIN_0
  *           @arg @ref FL_GPIO_PIN_1
...
/**
  ...
  * @rmtoll   PUDEN    PUDEN    FL_GPIO_EnablePinPulldown
  * @param    GPIOx GPIO Port
  * @param    pin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_PIN_0
  *           @arg @ref FL_GPIO_PIN_1
...
{
    SET_BIT(GPIOx->PUDEN, ((pin & 0xffff) << 16U));
}

/**
  * @brief    GPIOx Pull-Down disable
  * @rmtoll   PUDEN    PUDEN    FL_GPIO_DisablePinPulldown
  * @param    GPIOx GPIO Port
  * @param    pin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_PIN_0
  *           @arg @ref FL_GPIO_PIN_1
...
{
    CLEAR_BIT(GPIOx->PUDEN, ((pin & 0xffff) << 16U));
}

/**
  * @brief    Get GPIOx Pull-Down enable status
  * @rmtoll   INEN        FL_GPIO_IsEnabledPinPulldown
  * @param    GPIOx GPIO Port
  * @param    pin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_PIN_0
  *           @arg @ref FL_GPIO_PIN_1
...
{
    return (uint32_t)(READ_BIT(GPIOx->PUDEN, ((pin & 0xffff) << 16U)) == ((pin & 0xffff) << 16U));
}
...
/**
  ...
  *           @arg @ref FL_GPIO_PINREMAP_FUNCTON4
  * @retval   None
  */
...
/**
  ...
  * @param    GPIOx GPIO Port
  * @param    EXTIPin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_EXTI_LINE_10_PC12
  *           @arg @ref FL_GPIO_EXTI_LINE_10_PC13
  *           @arg @ref FL_GPIO_EXTI_LINE_10_PC14
  *           @arg @ref FL_GPIO_EXTI_LINE_10_PC15
  * @retval   None
  */
...
/**
  ...
  * @rmtoll   EXTISEL    EXTI15    FL_GPIO_SetExtiLine15
  * @param    GPIOx GPIO Port
  * @param    EXTIPin This parameter can be one of the following values:
  *           @arg @ref FL_GPIO_EXTI_LINE_15_PD12
  *           @arg @ref FL_GPIO_EXTI_LINE_15_PD13
  *           @arg @ref FL_GPIO_EXTI_LINE_15_PD14
  *           @arg @ref FL_GPIO_EXTI_LINE_15_PD15
  * @retval   None
  */
__STATIC_INLINE void FL_GPIO_SetExtiLine15(GPIO_COMMON_Type *GPIOx, uint32_t EXTIPin)
{
    MODIFY_REG(GPIOx->EXTISEL, GPIO_EXTISEL_EXTI15_Msk, EXTIPin);
}

/**
  * @brief    Get EXTI15 interrupt input
  * @rmtoll   EXTISEL    EXTI15    FL_GPIO_GetExtiLine15
  * @param    GPIOx GPIO Port
  * @retval   Returned value can be one of the following values:
  */
__STATIC_INLINE uint32_t FL_GPIO_GetExtiLine15(GPIO_COMMON_Type *GPIOx)
{
    return (uint32_t)(READ_BIT(GPIOx->EXTISEL, GPIO_EXTISEL_EXTI15_Msk));
}
...
/**
  ...
  *           @arg @ref FL_GPIO_DRIVESTRENGTH_X2
