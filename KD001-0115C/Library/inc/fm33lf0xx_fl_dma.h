...
#ifndef __FM33LF0XX_FL_DMA_H
#define __FM33LF0XX_FL_DMA_H
...
typedef struct
{
    ...
    __I  uint32_t TFSADDR[4];             /*!<  ,                                                     Address offset: 0x304 */
} DMA_ADDR;
...
#define    DMA_CFGR_RSEL_Msk                                      (0x3fU << DMA_CFGR_RSEL_Pos)
...
//#define    DMA_CFGR_PRI_Pos                                       (0U)
//#define    DMA_CFGR_PRI_Msk                                       (0x7fU << DMA_CFGR_PRI_Pos)
...
#define    FL_DMA_MEMORY_INC_MODE_UNEXCHANGE                         (0x0U << DMA_CHCR_MINC_Pos)
...
#define    FL_DMA_PERIPHERAL_INC_MODE_UNEXCHANGE                  (0x0U << DMA_CHCR_PINC_Pos)
...
#define    FL_DMA_CHANNEL_SPI0_RX                                 (0x0U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_SPI1_RX                                 (0x1U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_SPI0_TX                                 (0x2U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_SPI1_TX                                 (0x3U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART0_RX                                (0x4U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART1_RX                                (0x5U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART2_RX                                (0x6U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART3_RX                                (0x7U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART4_RX                                (0x8U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART0_TX                                (0x9U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART1_TX                                (0xaU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART2_TX                                (0xbU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART3_TX                                (0xcU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_UART4_TX                                (0xdU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LPUART0_RX                              (0xeU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LPUART1_RX                              (0xfU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LPUART0_TX                              (0x10U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LPUART1_TX                              (0x11U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_I2C_SMB0_RX                             (0x12U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_I2C_SMB1_RX                             (0x13U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_I2C_SMB0_TX                             (0x14U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_I2C_SMB1_TX                             (0x15U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_AES_IN                                  (0x16U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_AES_OUT                                 (0x17U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_CRC                                     (0x18U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_CH1                               (0x19U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_CH2                               (0x1aU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_CH3                               (0x1bU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_CH4                               (0x1cU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_TRIG                              (0x1dU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_COM                               (0x1eU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ATIM0_UEV                               (0x1fU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM0_CH1                              (0x20U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM0_CH2                              (0x21U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM0_CH3                              (0x22U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM0_CH4                              (0x23U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM0_TRIG                             (0x24U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM0_UEV                              (0x25U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM1_CH1                              (0x26U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM1_CH2                              (0x27U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM1_CH3                              (0x28U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM1_CH4                              (0x29U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM1_TRIG                             (0x2aU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_GPTIM1_UEV                              (0x2bU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_BSTIM0_TRIG                             (0x2cU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LPTIM0_TRIG                             (0x2dU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ADC_ACQ0                                (0x2eU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ADC_ACQ1                                (0x2fU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ADC_ACQ2                                (0x30U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ADC_ACQ3                                (0x31U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_ADC_SCANACQ                             (0x32U << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_DAC                                     (0x3cU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LED_PWMCR                               (0x3dU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_LED_DOTDR                               (0x3eU << DMA_CFGR_RSEL_Pos)
#define    FL_DMA_CHANNEL_SWTRIG                                  (0x3fU << DMA_CFGR_RSEL_Pos)


#define    FL_DMA_PRIORITY_LOW                                    (0x0U << DMA_CFGR_PRI_Pos)
#define    FL_DMA_PRIORITY_MEDIUM                                 (0x1U << DMA_CFGR_PRI_Pos)
#define    FL_DMA_PRIORITY_HIGH                                   (0x2U << DMA_CFGR_PRI_Pos)
#define    FL_DMA_PRIORITY_VERYHIGH                               (0x3U << DMA_CFGR_PRI_Pos)


#define    FL_DMA_FLASH_PRIORITY_LOW                              (0x0U << DMA_CH7CR_PRI_Pos)
#define    FL_DMA_FLASH_PRIORITY_MEDIUM                           (0x1U << DMA_CH7CR_PRI_Pos)
#define    FL_DMA_FLASH_PRIORITY_HIGH                             (0x2U << DMA_CH7CR_PRI_Pos)
#define    FL_DMA_FLASH_PRIORITY_VERYHIGH                         (0x3U << DMA_CH7CR_PRI_Pos)
...
/**
  ...
  * @rmtoll   CHCR    MINC    FL_DMA_SetMemoryIncrementMode 

  * @param    DMAx DMA instance
  * @param    mode This parameter can be one of the following values:
  *           @arg @ref FL_DMA_MEMORY_INC_MODE_UNEXCHANGE
...
/**
  ...
  * @param    DMAx DMA instance
  * @param    mode This parameter can be one of the following values:
  *           @arg @ref FL_DMA_PERIPHERAL_INC_MODE_UNEXCHANGE
...
__STATIC_INLINE void FL_DMA_WriteTransmissionSize(DMA_Type* DMAx, uint32_t size, uint32_t channel)
{
    ...
    {
        MODIFY_REG(Temp->CH7CR, (0x1ffU << 16U), (size << 16U));
    }
}
...
/**
  ...
  *           @arg @ref FL_DMA_CHANNEL_I2C_SMB0_RX
  *           @arg @ref FL_DMA_CHANNEL_I2C_SMB1_RX
  *           @arg @ref FL_DMA_CHANNEL_I2C_SMB0_TX
  *           @arg @ref FL_DMA_CHANNEL_I2C_SMB1_TX
  ...
  *           @arg @ref FL_DMA_CHANNEL_GPTIM0_TRIG
  ...
  *           @arg @ref FL_DMA_CHANNEL_GPTIM1_TRIG
  *           @arg @ref FL_DMA_CHANNEL_GPTIM1_UEV
  *           @arg @ref FL_DMA_CHANNEL_BSTIM0_TRIG
  *           @arg @ref FL_DMA_CHANNEL_LPTIM0_TRIG
  ...
  *           @arg @ref FL_DMA_CHANNEL_LED_PWMCR
  *           @arg @ref FL_DMA_CHANNEL_LED_DOTDR
...
__STATIC_INLINE void FL_DMA_SetPeripheralMap(DMA_Type* DMAx, uint32_t peripheral, uint32_t channel)
{
    ...
    if(channel <= FL_DMA_CHANNEL_3)
    {
        MODIFY_REG(Temp->Channel[channel].CFGR, DMA_CFGR_RSEL_Msk, peripheral);
    }
}
...
__STATIC_INLINE void FL_DMA_SetPriority(DMA_Type* DMAx, uint32_t priority, uint32_t channel)
{
    ...
    if(channel <= FL_DMA_CHANNEL_3)
    {
        MODIFY_REG(Temp->Channel[channel].CFGR, DMA_CFGR_PRI_Msk, priority);
    }
}
...
__STATIC_INLINE uint32_t FL_DMA_GetPriority(DMA_Type* DMAx, uint32_t channel)
{
    ...
    if(channel <= FL_DMA_CHANNEL_3)
    {
        return (uint32_t)(READ_BIT(Temp->Channel[channel].CFGR, DMA_CFGR_PRI_Msk));
    }
    else
    {
        return (uint32_t)(READ_BIT(Temp->CH7CR, DMA_CFGR_PRI_Msk));
    }
}
...
/**
  ...
  * @rmtoll   MEMAD0        FL_DMA_WriteMemoryAddress
  * @param    DMAx DMA instance
  * @param    data 
  * @param    channel This parameter can be one of the following values:
  *           @arg @ref FL_DMA_CHANNEL_0
...
/**
  ...
  * @rmtoll   CFGR    PRI    FL_DMA_SetChannelxSoftTrigger
  * @param    DMAx DMA instance
...
/**
  ...
  * @rmtoll   CFGR    PRI    FL_DMA_GetChannelxSoftTrigger
  * @param    DMAx DMA instance
  * @param    channel This parameter can be one of the following values:
  *           @arg @ref FL_DMA_CHANNEL_0
  *           @arg @ref FL_DMA_CHANNEL_1
