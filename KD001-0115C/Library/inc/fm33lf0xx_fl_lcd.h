...
#define    LCD_CR_LMUX_Msk                                        (0x08000003U << LCD_CR_LMUX_Pos)
...
#define    FL_LCD_COM_NUM_1COM                                    (0x08000000U << LCD_CR_LMUX_Pos)
#define    FL_LCD_COM_NUM_2COM                                    (0x08000001U << LCD_CR_LMUX_Pos)
#define    FL_LCD_COM_NUM_3COM                                    (0x08000003U << LCD_CR_LMUX_Pos)
...
/**
  ...
  *           @arg @ref FL_LCD_COM_NUM_1COM
  *           @arg @ref FL_LCD_COM_NUM_2COM
  *           @arg @ref FL_LCD_COM_NUM_3COM
  * @retval   None
  */
