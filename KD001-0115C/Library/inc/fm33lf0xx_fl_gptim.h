...
#ifndef __FM33LF0XX_FL_GPTIM_H
#define __FM33LF0XX_FL_GPTIM_H
...
#define    GPTIM_CR2_MMS_H_Pos                                    (25U)
#define    GPTIM_CR2_MMS_H_Msk                                    (0x1U << GPTIM_CR2_MMS_H_Pos)
#define    GPTIM_CR2_MMS_H                                        GPTIM_CR2_MMS_H_Msk
...
#define    GPTIM_DIER_TERRIR_Pos                                  (23U)
#define    GPTIM_DIER_TERRIR_Msk                                  (0x1U << GPTIM_DIER_TERRIR_Pos)
#define    GPTIM_DIER_TERRIR                                      GPTIM_DIER_TERRIR_Msk
...
#define    GPTIM_EGR_CCG_Msk                                      (0xfU << GPTIM_EGR_CCG_Pos)
...
#define    GPTIM_CCER_CCNP_Pos                                    (3U)
#define    GPTIM_CCER_CCNP_Msk                                    (0x1U << GPTIM_CCER_CCNP_Pos)
#define    GPTIM_CCER_CCNP                                        GPTIM_CCER_CCNP_Msk
...
#define    GPTIM_ECR_IE_Pos                                        (0U)
#define    GPTIM_ECR_IE_Msk                                        (0x1U << GPTIM_ECR_IE_Pos)
#define    GPTIM_ECR_IE                                            GPTIM_ECR_IE_Msk
...
#define    GPTIM_AFR_OCCRSEL_Pos                                   (16)
#define    GPTIM_AFR_OCCRSEL_Msk                                   (0x7U << GPTIM_AFR_OCCRSEL_Pos)
#define    GPTIM_AFR_OCCRSEL                                       GPTIM_AFR_OCCRSEL_Msk

#define    GPTIM_TISEL_Pos                                  			 (0U)
#define    GPTIM_TISEL_Msk                                   			 (0xfU << GPTIM_AFR_ETRSEL_Pos)
#define    GPTIM_TISEL                                       			 GPTIM_TISEL_Msk
...
#define    FL_GPTIM_SMSPS_TIMUPDATE                               (0x0U << GPTIM_SMCR_SMSPS_Pos)
#define    FL_GPTIM_SMSPS_INDEX                                   (0x1U << GPTIM_SMCR_SMSPS_Pos)


#define    FL_GPTIM_OCREF_CLR                       							(0x0U << GPTIM_SMCR_OCCS_Pos)
#define    FL_GPTIM_OCREF_ETRF                            				(0x1U << GPTIM_SMCR_OCCS_Pos)
...
#define    FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI1       						  (0xeU << GPTIM_SMCR_SMS_Pos)
#define    FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI2         						(0xfU << GPTIM_SMCR_SMS_Pos)
...
#define    FL_GPTIM_OC_MODE_COMBINED_PWM1                         (0x1004U << GPTIM_CCMR_OCM_Pos)
#define    FL_GPTIM_OC_MODE_COMBINED_PWM2                         (0x1005U << GPTIM_CCMR_OCM_Pos)
#define    FL_GPTIM_OC_MODE_ASSYMETRIC_PWM1                       (0x1006U << GPTIM_CCMR_OCM_Pos)
#define    FL_GPTIM_OC_MODE_ASSYMETRIC_PWM2                       (0x1007U << GPTIM_CCMR_OCM_Pos)
...
#define    FL_GPTIM_OCN_POLARITY_NORMAL                            (0x0U << GPTIM_CCER_CCNP_Pos)
#define    FL_GPTIM_OCN_POLARITY_INVERT                            (0x1U << GPTIM_CCER_CCNP_Pos)

#define    FL_GPTIM_IC_POLARITY_NORMAL                            (0x0U << GPTIM_CCER_CCIP_Pos)
#define    FL_GPTIM_IC_POLARITY_INVERT                            (0x1U << GPTIM_CCER_CCIP_Pos)\

#define    FL_GPTIM_INDEX_POSITION_DOWN_DOWN                       (0x0U << GPTIM_ECR_IPOS_Pos)
#define    FL_GPTIM_INDEX_POSITION_DOWN_UP                         (0x1U << GPTIM_ECR_IPOS_Pos)
#define    FL_GPTIM_INDEX_POSITION_UP_DOWN                         (0x2U << GPTIM_ECR_IPOS_Pos)
#define    FL_GPTIM_INDEX_POSITION_UP_UP                           (0x3U << GPTIM_ECR_IPOS_Pos)

#define    FL_GPTIM_INDEX_FIRST_ONLY                               (0x1U << GPTIM_ECR_FIDX_Pos)
#define    FL_GPTIM_INDEX_ALL                                      (0x0U << GPTIM_ECR_FIDX_Pos)

#define    FL_GPTIM_INDEX_UP_DOWN                                  (0x0U << GPTIM_ECR_IDIR_Pos)
#define    FL_GPTIM_INDEX_UP                                       (0x1U << GPTIM_ECR_IDIR_Pos)
#define    FL_GPTIM_INDEX_DOWN                                     (0x2U << GPTIM_ECR_IDIR_Pos)

#define    FL_GPTIM_ETR_Input_time_etr_in0                        (0x0U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in1                        (0x1U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in2                        (0x2U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in3                        (0x3U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in4                        (0x4U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in5                        (0x5U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in6                        (0x6U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in7                        (0x7U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in8                        (0x8U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in9                        (0x9U << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in10                       (0xaU << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in11                       (0xbU << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in12                       (0xcU << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in13                       (0xdU << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in14                       (0xeU << GPTIM_AFR_ETRSEL_Pos)
#define    FL_GPTIM_ETR_Input_time_etr_in15                       (0xfU << GPTIM_AFR_ETRSEL_Pos)

#define    FL_GPTIM_OCCR_COMP1_OUT                                 (0x0U << GPTIM_AFR_OCCRSEL_Pos)
#define    FL_GPTIM_OCCR_COMP2_OUT                                 (0x1U << GPTIM_AFR_OCCRSEL_Pos)
#define    FL_GPTIM_OCCR_COMP3_OUT                                 (0x2U << GPTIM_AFR_OCCRSEL_Pos)
...
/**
  ...
  * @rmtoll   SMCR    OCCS    FL_GPTIM_SetOCRefClearInputSource
  * @param    TIMx TIM instance
  * @param    OCRefClearInputSource This parameter can be one of the following values:
  *           @arg @ref FL_GPTIM_OCREF_CLR
  *           @arg @ref FL_GPTIM_OCREF_ETRF
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_SetOCRefClearInputSource(GPTIM_Type* TIMx, uint32_t OCRefClearInputSource)
{
    MODIFY_REG(TIMx->SMCR, GPTIM_SMCR_OCCS_Msk, OCRefClearInputSource);
}

/**
  * @brief    Get the OCREF clear input sourc
  * @rmtoll   SMCR    OCCS    FL_GPTIM_GetOCRefClearInputSource
  * @param    TIMx TIM instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_GPTIM_OCREF_CLR
  *           @arg @ref FL_GPTIM_OCREF_ETRF
  */
__STATIC_INLINE uint32_t FL_GPTIM_GetOCRefClearInputSource(GPTIM_Type* TIMx)
{
...
/**
  ...
  *           @arg @ref FL_GPTIM_SMSPS_TIMUPDATE
  *           @arg @ref FL_GPTIM_OCREF_INDEX
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_SetSMSPreloadSource(GPTIM_Type* TIMx, uint32_t PreloadSource)
{
    MODIFY_REG(TIMx->SMCR, GPTIM_SMCR_SMSPS_Msk, PreloadSource);
}
...
/**
  * @brief    
  * @rmtoll   SMCR    SMSPE    FL_GPTIM_IsEnabledSMS_preload
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsEnabledSMS_preload(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   SMCR    SMSPE    FL_GPTIM_DisableSMS_preload
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_DisableSMS_preload(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   SMCR    SMSPE    FL_GPTIM_ENableSMS_preload
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_ENableSMS_preload(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   SMCR    TS_L    FL_GPTIM_GetTriggerInput_L
  * @param    TIMx TIM instance
  * @param    triggerInput This parameter can be one of the following values:
  *           @arg @ref FL_GPTIM_TIM_TS_ITR0
  *           @arg @ref FL_GPTIM_TIM_TS_ITR1
  *           @arg @ref FL_GPTIM_TIM_TS_L_ITR2
  *           @arg @ref FL_GPTIM_TIM_TS_L_ITR3
  *           @arg @ref FL_GPTIM_TIM_TS_L_TI1F_ED
  *           @arg @ref FL_GPTIM_TIM_TS_L_TI1FP1
  *           @arg @ref FL_GPTIM_TIM_TS_L_TI2FP2
  *           @arg @ref FL_GPTIM_TIM_TS_L_ETRF
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_GPTIM_TIM_TS_L_ITR0
  *           @arg @ref FL_GPTIM_TIM_TS_L_ITR1
  *           @arg @ref FL_GPTIM_TIM_TS_L_ITR2
  *           @arg @ref FL_GPTIM_TIM_TS_L_ITR3
  *           @arg @ref FL_GPTIM_TIM_TS_L_TI1F_ED
  *           @arg @ref FL_GPTIM_TIM_TS_L_TI1FP1
  ...
  *           @arg @ref FL_GPTIM_TIM_TS_L_ETRF
  */
__STATIC_INLINE uint32_t FL_GPTIM_GetTriggerInput_L(GPTIM_Type* TIMx, uint32_t triggerInput)
{
...
/**
  ...
  *           @arg @ref FL_GPTIM_SLAVE_MODE_TRGI_RISE_RST_RUN
  *           @arg @ref FL_GPTIM_SLAVE_MODE_TRGI_HIGH_RISE_RUN
  *           @arg @ref FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLK_DIR_X2
  *           @arg @ref FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLK_DIR_X1
  *           @arg @ref FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLKWithDIR_X2
  *           @arg @ref FL_GPTIM_SLAVE_MODE_TRGI_Encoder_CLKWithDIR_X1
  *           @arg @ref FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI1
  *           @arg @ref FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI2
  * @retval   None
  */
...
/**
  ...
  *           @arg @ref FL_GPTIM_SLAVE_MODE_ENCODER_X1_TI2
  */
__STATIC_INLINE uint32_t FL_GPTIM_GetSlaveMode(GPTIM_Type* TIMx, uint32_t encoderMode)
{
...
/**
  * @brief    
  * @rmtoll   DIER    TERRIR    FL_GPTIM_EnableTransError
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_EnableTransError(GPTIM_Type* TIMx)
{
    SET_BIT(TIMx->DIER, GPTIM_DIER_TERRIR_Msk);
}

/**
  * @brief    
  * @rmtoll   DIER    TERRIE    FL_GPTIM_IsEnabledIT_TransError
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsEnabledIT_TransError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    TERRIE    FL_GPTIM_DisableIT_TransError
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_DisableIT_TransError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    DIRIE    FL_GPTIM_EnableIT_DirError
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_EnableIT_DirError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    DIRIE    FL_GPTIM_IsEnabledIT_DirError
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsEnabledIT_DirError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    DIRIE    FL_GPTIM_DisableIT_DirError
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_DisableIT_DirError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    IDXIE    FL_GPTIM_EnableIT_IndexIT
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_EnableIT_IndexIT(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    IDXIE    FL_GPTIM_IsEnabledIT_IndexIT
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsEnabledIT_IndexIT(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   DIER    IDXIE    FL_GPTIM_DisableIT_IndexIT
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_DisableIT_IndexIT(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ISR    TERRIF    FL_GPTIM_IsActiveFlag_TransError
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsActiveFlag_TransError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ISR    TERRIF    FL_GPTIM_ClearFlag_TransError
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_ClearFlag_TransError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ISR    DIRIF    FL_GPTIM_IsActiveFlag_DirError
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsActiveFlag_DirError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ISR    DIRIF    FL_GPTIM_ClearFlag_DirError
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_ClearFlag_DirError(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ISR    IDXIF    FL_GPTIM_IsActiveFlag_IndexIT
  * @param    TIMx TIM instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_GPTIM_IsActiveFlag_IndexIT(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ISR    IDXIF    FL_GPTIM_ClearFlag_IndexIT
  * @param    TIMx TIM instance
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_ClearFlag_IndexIT(GPTIM_Type* TIMx)
{
...
{
    SET_BIT(TIMx->EGR, ((channel & 0xf) << 0x1U));
}
...
/**
  * @brief    OPM模式使能
  * @rmtoll   CCMR    OCM_H    FL_GPTIM_SetOPM_Mode
  * @param    TIMx TIM instance
  * @param    mode This parameter can be one of the following values:
  * @param    channel This parameter can be one of the following values:
  *           @arg @ref FL_GPTIM_CLK_DIVISION
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_EnableOPM_Mode(GPTIM_Type* TIMx, uint32_t mode, uint32_t channel)
{
	switch(channel)
    {
        case FL_GPTIM_CHANNEL_1:
            SET_BIT(TIMx->CCMR1, (0x1U << 16U));
            break;
        case FL_GPTIM_CHANNEL_2:
            SET_BIT(TIMx->CCMR1, (0x1U << 24U));
            break;
        case FL_GPTIM_CHANNEL_3:
            SET_BIT(TIMx->CCMR2, (0x1U << 16U));
            break;
        case FL_GPTIM_CHANNEL_4:
            SET_BIT(TIMx->CCMR2, (0x1U << 24U));
            break;
    }
}
...
/**
  ...
  * @param    TIMx TIM instance
  * @param    mode This parameter can be one of the following values:
  *           @arg @ref FL_GPTIM_OC_MODE_FROZEN_OPM1
  *           @arg @ref FL_GPTIM_OC_MODE_ACTIVE_OPM2
...
/**
  * @brief
  * @rmtoll   CCER    CCNP    FL_GPTIM_OCN_SetChannelPolarity
  * @param    TIMx TIM instance
  * @param    polarity This parameter can be one of the following values:
...
{
    MODIFY_REG(TIMx->CCER, (GPTIM_CCER_CCNP_Msk << (channel * 4)), (polarity << (channel * 4)));
}
...
/**
  * @brief    
  * @rmtoll   ECR    IPOS    FL_GPTIM_SetIndexPositioning
  * @param    TIMx TIM instance
  * @param    mode This parameter can be one of the following values:
              @arg @ref FL_GPTIM_INDEX_POSITION_DOWN_DOWN
						  @arg @ref FL_GPTIM_INDEX_POSITION_DOWN_UP
						  @arg @ref FL_GPTIM_INDEX_POSITION_UP_DOWN
							@arg @ref FL_GPTIM_INDEX_POSITION_UP_UP
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_SetIndexPositioning(GPTIM_Type* TIMx, uint32_t mode)
{
    MODIFY_REG(TIMx->ECR, GPTIM_ECR_IPOS_Msk, mode);
}

/**
  * @brief    
  * @note     
  * @rmtoll   ECR    FIDX    FL_GPTIM_SetIDXMode
  * @param    TIMx TIM instance
  * @param    IDXmode This parameter can be one of the following values:
  *           @arg @ref FL_GPTIM_INDEX_FIRST_ONLY
  *           @arg @ref FL_GPTIM_INDEX_ALL
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_SetIDXMode(GPTIM_Type* TIMx, uint32_t IDXmode)
{
    MODIFY_REG(TIMx->ECR, GPTIM_ECR_FIDX_Msk, IDXmode);
}

/**
  * @brief    
  * @note    
  * @rmtoll   ECR    FIDX    FL_GPTIM_GetIDXMode
  * @param    TIMx TIM instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_GPTIM_INDEX_FIRST_ONLY
  *           @arg @ref FL_GPTIM_INDEX_ALL
  */
__STATIC_INLINE uint32_t FL_GPTIM_GetIDXMode(GPTIM_Type* TIMx)
{
...
/**
  * @brief    
  * @rmtoll   ECR    IDIR    FL_GPTIM_SetIndex_Dir
  * @param    TIMx TIM instance
  * @param    polarity This parameter can be one of the following values:
							@arg @ref FL_GPTIM_INDEX_UP_DOWN
							@arg @ref FL_GPTIM_INDEX_UP
							@arg @ref FL_GPTIM_INDEX_DOWN

  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_SetIndex_Dir(GPTIM_Type* TIMx, uint32_t polarity)
{
    MODIFY_REG(TIMx->ECR, GPTIM_ECR_IDIR_Msk, polarity);
}
...
{
    CLEAR_BIT(TIMx->ECR, GPTIM_ECR_IE_Msk);
}
...
{
    SET_BIT(TIMx->ECR, GPTIM_ECR_IE_Msk);
}

/**
  * @brief    
  * @rmtoll   AFR    ETRSEL    FL_GPTIM_SetETR_Input_Source
  * @param    TIMx TIM instance
  * @param    source This parameter can be one of the following values:
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in0
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in1
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in2
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in3
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in4
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in5
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in6
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in7
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in8
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in9
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in10
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in11
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in12
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in13
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in14
  *           @arg @ref FL_GPTIM_ETR_Input_time_etr_in15
  * @retval   None
  */
__STATIC_INLINE void FL_GPTIM_SetETR_Input_Source(GPTIM_Type* TIMx, uint32_t source)
{
...
/**
  * @brief    
  * @rmtoll       OCC1R_SEL    FL_SetOCREF_CLR_Source
  * @param    TIMx TIM instance
  * @param    mode This parameter can be one of the following values:
  * @retval   None
  */
__STATIC_INLINE void FL_SetOCREF_CLR_Source(GPTIM_Type* TIMx, uint32_t mode)
{
    MODIFY_REG(TIMx->AFR, GPTIM_AFR_OCCRSEL_Msk, mode);
}
...
FL_ErrorStatus FL_GPTIM_OC_Init(GPTIM_Type *TIMx, uint32_t channel, FL_GPTIM_OC_InitTypeDef *ic_init); 
/**
  * @}
  */
