...
#ifndef __FM33LF0XX_FL_SVD_H
#define __FM33LF0XX_FL_SVD_H
...
#define    FL_SVD_CR_WARNING                                      (0x1U << SVD_CR_EN_Pos)
#define    FL_SVD_CR_RESET                                        (0x2U << SVD_CR_EN_Pos)
...
/**
  * @brief    SVD_Enable
  * @rmtoll   CR    SVDEN    FL_SVD_Enable
  * @param    SVDx SVD instance
  * @param    mode This parameter can be one of the following values:
  *           @arg @ref FL_SVD_CR_WARNING
  *           @arg @ref FL_SVD_CR_RESET
  * @retval   None
  */
__STATIC_INLINE void FL_SVD_Enable(SVD_Type *SVDx, uint32_t mode)
{
...
/**
  * @brief    SVD_Disable
  * @rmtoll   CR    SVDEN    FL_SVD_Disable
  * @param    SVDx SVD instance
  * @retval   Returned value can be one of the following values:
  */
