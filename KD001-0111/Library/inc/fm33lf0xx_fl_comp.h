...
#ifndef __FM33LF0XX_FL_COMP_H
#define __FM33LF0XX_FL_COMP_H
...
#define    COMP_ICR_CMP4SEL_Pos                                   (26U)
#define    COMP_ICR_CMP4SEL_Msk                                   (0x3U << COMP_ICR_CMP4SEL_Pos)
#define    COMP_ICR_CMP4SEL                                       COMP_ICR_CMP4SEL_Msk

#define    COMP_ICR_CMP4IE_Pos                                    (24U)
#define    COMP_ICR_CMP4IE_Msk                                    (0x1U << COMP_ICR_CMP4IE_Pos)
#define    COMP_ICR_CMP4IE                                        COMP_ICR_CMP4IE_Msk
...
#define    COMP_ISR_CMP4IF_Pos                                    (3U)
#define    COMP_ISR_CMP4IF_Msk                                    (0x1U << COMP_ISR_CMP4IF_Pos)
#define    COMP_ISR_CMP4IF                                        COMP_ISR_CMP4IF_Msk
...
#define    FL_COMP_BLANKSEL_SOURCE_NONE                           (0x0U << COMP_CR_BLANKSEL_Pos)
#define    FL_COMP_BLANKSEL_SOURCE_ATIM_OC5                       (0x1U << COMP_CR_BLANKSEL_Pos)
#define    FL_COMP_BLANKSEL_SOURCE_GPTIM0_OC3                     (0x2U << COMP_CR_BLANKSEL_Pos)
#define    FL_COMP_BLANKSEL_SOURCE_GPTIM1_OC3                     (0x3U << COMP_CR_BLANKSEL_Pos)
...
#define    FL_COMP_INP_SOURCE_OPA_OUT                             (0x2U << COMP_CR_VPSEL_Pos)


#define    FL_COMP_INN_SOURCE_INN1                                (0x0U << COMP_CR_VNSEL_Pos)
#define    FL_COMP_INN_SOURCE_DAC_OUT                             (0x1U << COMP_CR_VNSEL_Pos)
#define    FL_COMP_INN_SOURCE_AVREF                               (0x2U << COMP_CR_VNSEL_Pos)
#define    FL_COMP_INN_SOURCE_AVREF_DIV_2                         (0x3U << COMP_CR_VNSEL_Pos)


#define    FL_COMP_COMP4_INTERRUPT_EDGE_BOTH                      (0x0U << COMP_ICR_CMP4SEL_Pos)
#define    FL_COMP_COMP4_INTERRUPT_EDGE_RISING                    (0x1U << COMP_ICR_CMP4SEL_Pos)
#define    FL_COMP_COMP4_INTERRUPT_EDGE_FALLING                   (0x2U << COMP_ICR_CMP4SEL_Pos)
...
/**
  ...
  *           @arg @ref FL_COMP_BLANKSEL_SOURCE_NONE
  *           @arg @ref FL_COMP_BLANKSEL_SOURCE_ATIM_OC5
  *           @arg @ref FL_COMP_BLANKSEL_SOURCE_GPTIM0_OC3
  *           @arg @ref FL_COMP_BLANKSEL_SOURCE_GPTIM1_OC3
  * @retval   None
  */
...
/**
  ...
  *           @arg @ref FL_COMP_INN_SOURCE_DAC_OUT
...
/**
  * @brief    Set comparator4 interrupt edge
  * @rmtoll   ICR    CMP4SEL    FL_COMP_SetComparator4InterruptEdge
  * @param    COMPx COMP instance
  * @param    edge This parameter can be one of the following values:
  *           @arg @ref FL_COMP_COMP4_INTERRUPT_EDGE_BOTH
  *           @arg @ref FL_COMP_COMP4_INTERRUPT_EDGE_RISING
  *           @arg @ref FL_COMP_COMP4_INTERRUPT_EDGE_FALLING
  * @retval   None
  */
__STATIC_INLINE void FL_COMP_SetComparator4InterruptEdge(COMP_COMMON_Type* COMPx, uint32_t edge)
{
    MODIFY_REG(COMPx->ICR, COMP_ICR_CMP4SEL_Msk, edge);
}

/**
  * @brief    Get comparator4 interrupt edge
  * @rmtoll   ICR    CMP4SEL    FL_COMP_GetComparator4InterruptEdge
  * @param    COMPx COMP instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_COMP_COMP4_INTERRUPT_EDGE_BOTH
  *           @arg @ref FL_COMP_COMP4_INTERRUPT_EDGE_RISING
  *           @arg @ref FL_COMP_COMP4_INTERRUPT_EDGE_FALLING
  */
__STATIC_INLINE uint32_t FL_COMP_GetComparator4InterruptEdge(COMP_COMMON_Type* COMPx)
{
    return (uint32_t)(READ_BIT(COMPx->ICR, COMP_ICR_CMP4SEL_Msk));
}

/**
  * @brief    Comparator4 interrupt enable
  * @rmtoll   ICR    CMP4IE    FL_COMP_EnableIT_Comparator4
  * @param    COMPx COMP instance
  * @retval   None
  */
__STATIC_INLINE void FL_COMP_EnableIT_Comparator4(COMP_COMMON_Type* COMPx)
{
    SET_BIT(COMPx->ICR, COMP_ICR_CMP4IE_Msk);
}

/**
  * @brief    Get comparator4 interrupt enable status
  * @rmtoll   ICR    CMP4IE    FL_COMP_IsEnabledIT_Comparator4
  * @param    COMPx COMP instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_COMP_IsEnabledIT_Comparator4(COMP_COMMON_Type* COMPx)
{
    return (uint32_t)(READ_BIT(COMPx->ICR, COMP_ICR_CMP4IE_Msk) == COMP_ICR_CMP4IE_Msk);
}

/**
  * @brief    Comparator4 interrupt disable
  * @rmtoll   ICR    CMP4IE    FL_COMP_DisableIT_Comparator4
  * @param    COMPx COMP instance
  * @retval   None
  */
__STATIC_INLINE void FL_COMP_DisableIT_Comparator4(COMP_COMMON_Type* COMPx)
{
    CLEAR_BIT(COMPx->ICR, COMP_ICR_CMP4IE_Msk);
}
...
/**
  * @brief    Get comparator4 interrupt flag
  * @rmtoll   ISR    CMP4IF    FL_COMP_IsActiveFlag_Comparator4
  * @param    COMPx COMP instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_COMP_IsActiveFlag_Comparator4(COMP_COMMON_Type* COMPx)
{
    return (uint32_t)(READ_BIT(COMPx->ISR, COMP_ISR_CMP4IF_Msk) == (COMP_ISR_CMP4IF_Msk));
}

/**
  * @brief    Clear comparator4 interrupt flag
  * @rmtoll   ISR    CMP4IF    FL_COMP_ClearFlag_Comparator4
  * @param    COMPx COMP instance
  * @retval   None
  */
__STATIC_INLINE void FL_COMP_ClearFlag_Comparator4(COMP_COMMON_Type* COMPx)
{
    WRITE_REG(COMPx->ISR, COMP_ISR_CMP4IF_Msk);
}
