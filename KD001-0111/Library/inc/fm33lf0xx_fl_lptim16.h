...
#ifndef __FM33FR0XX_FL_LPTIM16_H
#define __FM33FR0XX_FL_LPTIM16_H
...
typedef struct
{
    ...
    FL_FunState ICInputDigitalFilter;
...
/**
  * @brief    Enable Quaderate Decoder Direction Changed Interrupt
  * @rmtoll   IER    QDCIE    FL_LPTIM16_EnableIT_EncoderChangeDir
  * @param    LPTIM16x LPTIM16 instance
  * @retval   None
  */
__STATIC_INLINE void FL_LPTIM16_EnableIT_EncoderChangeDir(LPTIM16_Type *LPTIM16x)
{
    SET_BIT(LPTIM16x->IER, LPTIM16_IER_QDCIE_Msk);
}
...
/**
  * @brief    Disable Quaderate Decoder Direction Changed Interrupt
  * @rmtoll   IER    QDCIE    FL_LPTIM16_DisableIT_EncoderChangeDir
  * @param    LPTIM16x LPTIM16 instance
  * @retval   None
  */
__STATIC_INLINE void FL_LPTIM16_DisableIT_EncoderChangeDir(LPTIM16_Type *LPTIM16x)
{
    CLEAR_BIT(LPTIM16x->IER, LPTIM16_IER_QDCIE_Msk);
}
...
/**
  * @brief    Get Quaderate Decoder Direction Changed Interrupt Enable Status
  * @rmtoll   IER    QDCIE    FL_LPTIM16_IsEnabledIT_EncoderChangeDir
  * @param    LPTIM16x LPTIM16 instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_LPTIM16_IsEnabledIT_EncoderChangeDir(LPTIM16_Type *LPTIM16x)
{
    return (uint32_t)(READ_BIT(LPTIM16x->IER, LPTIM16_IER_QDCIE_Msk) == LPTIM16_IER_QDCIE_Msk);
}
...
/**
  * @brief    Get Quaderate Decoder Direction Changed Interrupt Flag
  * @rmtoll   ISR    QDCIF    FL_LPTIM16_IsActiveFlag_EncoderChangeDir
  * @param    LPTIM16x LPTIM16 instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_LPTIM16_IsActiveFlag_EncoderChangeDir(LPTIM16_Type *LPTIM16x)
{
    return (uint32_t)(READ_BIT(LPTIM16x->ISR, LPTIM16_ISR_QDCIF_Msk) == (LPTIM16_ISR_QDCIF_Msk));
}
...
/**
  * @brief    Clear Quaderate Decoder Direction Changed Interrupt Flag
  * @rmtoll   ISR    QDCIF    FL_LPTIM16_ClearFlag_EncoderChangeDir
  * @param    LPTIM16x LPTIM16 instance
  * @retval   None
  */
__STATIC_INLINE void FL_LPTIM16_ClearFlag_EncoderChangeDir(LPTIM16_Type *LPTIM16x)
{
    WRITE_REG(LPTIM16x->ISR, LPTIM16_ISR_QDCIF_Msk);
}
...
/**
  ...
  * @rmtoll   ISR    QDIR    FL_LPTIM16_GetEncoderDir
  * @param    LPTIM16x LPTIM16 instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_LPTIM16_ENCODER_DIR_CH1_BEFORE_CH2
  *           @arg @ref FL_LPTIM16_ENCODER_DIR_CH1_BEHIND_CH2
  */
__STATIC_INLINE uint32_t FL_LPTIM16_GetEncoderDir(LPTIM16_Type *LPTIM16x)
{
    return (uint32_t)(READ_BIT(LPTIM16x->ISR, LPTIM16_ISR_QDIR_Msk));
}
...
#endif /* __FM33FR0XX_FL_LPTIM16_H*/
