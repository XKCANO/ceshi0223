...
#ifndef __FM33LF0XX_FL_RTC_H
#define __FM33LF0XX_FL_RTC_H
...
/**
  * @brief FL RTC Init Sturcture definition
  */
typedef struct
{
    /** 年 */
...
#define    RTC_ADJUST_ADSIGN_Pos                                 (9U)
#define    RTC_ADJUST_ADSIGN_Msk                                 (0x1U << RTC_ADJUST_ADSIGN_Pos)
#define    RTC_ADJUST_ADSIGN                                     RTC_ADJUST_ADSIGN_Msk

#define    RTC_CR_EN_Pos                                         (0U)
#define    RTC_CR_EN_Msk                                         (0x1U << RTC_CR_EN_Pos)
#define    RTC_CR_EN                                             RTC_CR_EN_Msk
...
#define    FL_RTC_ADJUST_DIR_INCREASE                            (0x0U << RTC_ADJUST_ADSIGN_Pos)
#define    FL_RTC_ADJUST_DIR_DECREASE                            (0x1U << RTC_ADJUST_ADSIGN_Pos)
...
/**
  ...
  * @rmtoll   ADJUST    ADSIGN    FL_RTC_SetAdjustDirection
  * @param    RTCx RTC instance
...
{
    MODIFY_REG(RTCx->ADJUST, RTC_ADJUST_ADSIGN_Msk, adjustDir);
}

/**
  * @brief    Get RTC Adjust Direction
  * @rmtoll   ADJUST    ADSIGN    FL_RTC_GetAdjustDirection
  * @param    RTCx RTC instance
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_RTC_ADJUST_DIR_INCREASE
  *           @arg @ref FL_RTC_ADJUST_DIR_DECREASE
...
{
    return (uint32_t)(READ_BIT(RTCx->ADJUST, RTC_ADJUST_ADSIGN_Msk));
}
...
/**
  * @brief    RTC enable
  * @rmtoll   CR    EN    FL_RTC_Enable
  * @param    RTCx RTC instance
  * @retval   None
  */
__STATIC_INLINE void FL_RTC_Enable(RTC_Type *RTCx)
{
    SET_BIT(RTCx->CR, RTC_CR_EN_Msk);
}

/**
  * @brief    Get RTC enable status
  * @rmtoll   CR    EN    FL_RTC_IsEnabled
  * @param    RTCx RTC instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RTC_IsEnabled(RTC_Type *RTCx)
{
    return (uint32_t)(READ_BIT(RTCx->CR, RTC_CR_EN_Msk) == RTC_CR_EN_Msk);
}

/**
  * @brief    RTC disable
  * @rmtoll   CR    EN    FL_RTC_Disable
  * @param    RTCx RTC instance
  * @retval   None
  */
__STATIC_INLINE void FL_RTC_Disable(RTC_Type *RTCx)
{
    CLEAR_BIT(RTCx->CR, RTC_CR_EN_Msk);
}
