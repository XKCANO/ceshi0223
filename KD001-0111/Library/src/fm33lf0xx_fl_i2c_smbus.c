...
#define         IS_FL_I2C_SMBUS_CLOCKSRC(__VALUE__)                   	(((__VALUE__) == FL_CMU_I2CSMB0_CLK_SOURCE_APBCLK )||\
																		((__VALUE__) == FL_CMU_I2CSMB0_CLK_SOURCE_RCHF)||\
																		((__VALUE__) == FL_CMU_I2CSMB0_CLK_SOURCE_SYSCLK)||\
																		((__VALUE__) == FL_CMU_I2CSMB1_CLK_SOURCE_APBCLK)||\
...
FL_ErrorStatus FL_I2C_SMBUS_DeInit(I2CSMB_Type *I2CSMBx)
{
    ...
    {
        /* 复位I2CSMB1外设寄存器 */
        FL_RMU_EnableResetAPBPeripheral(RMU, FL_RMU_RSTAPB_I2CSMB1);
        FL_RMU_DisableResetAPBPeripheral(RMU, FL_RMU_RSTAPB_I2CSMB1);
    }
    else
    {
...
FL_ErrorStatus FL_I2C_SMBUS_MasterMode_Init(I2CSMB_Type *I2CSMBx, FL_I2C_SMBUS_MasterMode_InitTypeDef *I2CSMB_InitStruct)
{
    ...
    if(I2CSMBx == I2CSMB0)
    {
		...
		FL_CMU_EnableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_I2CSMB0);
    ...
    else if(I2CSMBx == I2CSMB1)
    {
		...
		FL_CMU_EnableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_I2CSMB1);		
	}
	else
	{
		return FL_FAIL;	
    ...
    {
        case FL_CMU_I2CSMB0_CLK_SOURCE_APBCLK://FL_CMU_I2CSMB1_CLK_SOURCE_APBCLK
