...
#define IS_FL_ATIM_CHANNEL(__VALUE__)              (((__VALUE__) == FL_ATIM_CHANNEL_1)\
                                                    ...
                                                    || ((__VALUE__) == FL_ATIM_CHANNEL_5)\
                                                    || ((__VALUE__) == FL_ATIM_CHANNEL_6))



#define IS_FL_ATIM_SLAVE_MODE(__VALUE__)           (((__VALUE__) == FL_ATIM_SLAVE_MODE_PROHIBITED)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_ENCODER_X1_TI1)\
                                                    ...
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_EXT_MODE1)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_COMBINED_RESETTRIGGER)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_COMBINED_GATEDRESET)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_CLOCKPLUSDIRECTION_X2)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_CLOCKPLUSDIRECTION_X1)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_DIRECTIONALCLOCK_X2)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_DIRECTIONALCLOCK_X1)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_X1_TI1)\
                                                    || ((__VALUE__) == FL_ATIM_SLAVE_MODE_X1_TI2))
...
#define IS_FL_ATIM_TRIGGER_SRC(__VALUE__)          (((__VALUE__) == FL_ATIM_TRGI_ITR0 )\
                                                        ...
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR4)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR5)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR6)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR7)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR8)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR9)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR10)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR11)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR12)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR13)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR14)\
                                                        ||((__VALUE__) ==FL_ATIM_TRGI_ITR15))
...
#define IS_FL_ATIM_OC_MODE(__VALUE__)               (((__VALUE__) ==   FL_ATIM_OC_MODE_FROZEN) \
                                                      ...
                                                      || ((__VALUE__) == FL_ATIM_OC_MODE_RETRIG_OPM1)\
                                                      || ((__VALUE__) == FL_ATIM_OC_MODE_RETRIG_OPM2)\
                                                      || ((__VALUE__) == FL_ATIM_OC_MODE_COMBINED_PWM1)\
                                                      || ((__VALUE__) == FL_ATIM_OC_MODE_COMBINED_PWM2)\
                                                      || ((__VALUE__) == FL_ATIM_OC_MODE_ASSYMETRIC_PWM1)\
                                                      || ((__VALUE__) == FL_ATIM_OC_MODE_ASSYMETRIC_PWM2))\
...
#define IS_FL_ATIM_BDTR_BREAKSOURCE(__VALUE__)       (((__VALUE__) == FL_ATIM_BKIN_SOURCE_GPIO1) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_GPIO2) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_COMP1) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_COMP2) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_COMP3) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_HFDET) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_SVD) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_LOCKUP) \
                                                     || ((__VALUE__) == FL_ATIM_BKIN_SOURCE_RAMPARITY))
...
FL_ErrorStatus FL_ATIM_DeInit(ATIM_Type *TIMx)
{
    ...
    /* 复位ATIM外设寄存器 */
    FL_RMU_EnableResetAPBPeripheral(RMU,FL_RMU_RSTAPB_ATIM0);
    FL_RMU_DisableResetAPBPeripheral(RMU,FL_RMU_RSTAPB_ATIM0);
    /* 关闭外设总线始时钟和工作时钟 */
    FL_CMU_DisableGroup4BusClock(FL_CMU_GROUP4_BUSCLK_ATIM);
    FL_CMU_DisableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_ATIM);
    /* 锁定外设复位 */
...
FL_ErrorStatus FL_ATIM_Init(ATIM_Type *TIMx, FL_ATIM_InitTypeDef *TIM_InitStruct)
{
    ...
    FL_CMU_EnableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_ATIM);
    /* 设置重复计数值 */
...
static FL_ErrorStatus OCConfig(ATIM_Type *TIMx, uint32_t channel, FL_ATIM_OC_InitTypeDef *TIM_OC_InitStruct)
{
    ...
    switch(channel)
    {
        ...
        case FL_ATIM_CHANNEL_4:
            ...
            break;
           case FL_ATIM_CHANNEL_5:
            FL_ATIM_WriteCompareCH5(TIMx, TIM_OC_InitStruct->compareValue);
            break;
           case FL_ATIM_CHANNEL_6:
            FL_ATIM_WriteCompareCH6(TIMx, TIM_OC_InitStruct->compareValue);
            break;
        default :
            result = FL_FAIL;
            break;
...
FL_ErrorStatus FL_ATIM_BDTR_Init(ATIM_Type *TIMx, uint32_t channel, FL_ATIM_BDTR_InitTypeDef *TIM_BDTR_InitStruct)
{
    ...
    assert_param(IS_FL_ATIM_BDTR_BREAKSOURCE(TIM_BDTR_InitStruct->breakSource));
    ...
    /* 刹车极性设置 */
    FL_ATIM_SetBreakPolarity(TIMx, channel,TIM_BDTR_InitStruct->breakPolarity);
    /* 刹车滤波设置 */
    FL_ATIM_SetBreakFilter(TIMx, channel,TIM_BDTR_InitStruct->breakFilter);
        /* 刹车通道配置 */ 
    FL_ATIM_SetBreakInput(TIMx, TIM_BDTR_InitStruct->breakSource);
    ...
    {
        FL_ATIM_EnableBreak(TIMx,channel);
    }
    else
    {
        FL_ATIM_DisableBreak(TIMx,channel);
    }
    /* 使能全部输出 */
...
void FL_ATIM_BDTR_StructInit(FL_ATIM_BDTR_InitTypeDef *TIM_BDTR_InitStruct)
{
    ...
    TIM_BDTR_InitStruct->breakSource         = FL_ATIM_BKIN_SOURCE_GPIO1 ;
}
