...
/* Private consts ------------------------------------------------------------*/
/** @addtogroup RNG_FL_Private_Consts
  * @{
  */
...
FL_ErrorStatus FL_RNG_Init(RNG_Type *RNGx)
{
    ...
    /* RNG 工作时钟使能*/
    FL_CMU_EnableGroup1OperationClock(FL_CMU_GROUP1_OPCLKEN_RNG);
    return FL_PASS;
}
...
/* Private functions ---------------------------------------------------------*/
/** @defgroup RNG_FL_Private_Functions RNG Private Functions
  * @{
  */
